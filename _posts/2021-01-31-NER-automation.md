...
txt.close()
```
Because the test data is Hungarian, but the model is trained on English text, we need to translate it.
```python
def english(text):
    HEADERS = {
    "Host": "www.bing.com",
